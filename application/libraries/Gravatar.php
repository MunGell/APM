...
class Gravatar
{
    ...
    public function __construct()
    {
        ...
        $this->_ci->config->load('gravatar'); 	// load gravatar config file

		$this->size					= $this->_ci->config->item('gravatar_size');
		$this->default_image		= $this->_ci->config->item('gravatar_default_image');
		$this->max_rating			= $this->_ci->config->item('gravatar_max_rating');
		$this->use_secure_url		= $this->_ci->config->item('gravatar_use_secure_url');
		$this->param_cache			= $this->_ci->config->item('gravatar_param_cache');
	}
	 ...
	 */
	public function getAvatar($email, $hash_email = true)
	{
